...
const Footer = () => {
    ...
    return (
        <div id='contact' className='w-full flex flex-col justify-center items-center'>
            ...
            <div className='w-full lg:px-20 px-5 py-[60px] bg-gray-100 grid lg:grid-cols-[auto,auto,auto,auto,auto] grid-cols-1 justify-between items-start lg:gap-3 gap-10'>
                <div data-aos="zoom-in" data-aos-delay="200" className='flex flex-col justify-center items-start gap-10 grow '>
                    <div className='flex flex-col justify-center items-start gap-4 '>
                        ...
                        <p className='text-gray-500 text-justify'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. <br />Voluptatum dicta excepturi perspiciatis illo aperiam nesciunt.</p>
                    </div>
                    <div className='flex flex-col justify-center items-start gap-4'>
            ...
            <div className='w-full lg:px-20 px-5 py-[40px] bg-gray-100 '>
                ...
                <div className='w-full flex lg:flex-row flex-col justify-between items-center lg:gap-4 gap-10'>
                    <div className='lg:w-[20%] w-full flex justify-center items-center gap-4 '>
                        <img src={pay1} alt="" className='w-[40px] rounded-lg ' />
                        <img src={pay2} alt="" className='w-[40px] rounded-lg ' />
                        <img src={pay3} alt="" className='w-[40px] rounded-lg ' />
                        <img src={pay4} alt="" className='w-[40px] rounded-lg ' />
                    </div>
                    <div className='lg:w-[60%] flex lg:flex-row flex-col justify-center items-center gap-4 flex-grow '>
                        <h1 className='text-black font-semibold text-2xl '>Subscribe Newsletter</h1>
                        <div>
                            <input type="email" name="email" placeholder='Enter your email' className='lg:w-auto w-full capitalize px-6 py-3 rounded-l-lg ' />
            ...
            {/* scroll to top btn */}
            <div id='icon-box' className='bg-themepurple text-white p-3 rounded-full hover:bg-themeyellow hover:text-black cursor-pointer lg:bottom-6 right-6 bottom-6'>

...
import { FaStar, FaRegHeart, FaShoePrints } from 'react-icons/fa'
...
const Productsgrid = () => {
    ...
    return (
        <div id='products' className='w-full lg:px-20 px-5 py-[80px] bg-gray-100 flex flex-col justify-center items-center gap-4 '>
            ...
            <div data-aos="zoom-in" data-aos-delay="300" className='w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-10 mt-10 '>
                {
                    products.map((item, index) => (
                        <div id='products-box' key={index} className='flex flex-col justify-center items-center bg-white gap-2 p-4 rounded-lg cursor-pointer relative'>
                            <img src={item.img} alt="" />
                            <div id='icons' className='flex justify-center items-center gap-3 absolute top-[20px] '>
                                <div className='bg-themepurple text-white  hover:bg-themeyellow hover:text-black rounded-full p-3 '>
                                    <FaRegHeart />
                                </div>
                                <div className='bg-themepurple text-white  hover:bg-themeyellow hover:text-black rounded-full p-3 '>
            ...
            <button data-aos="zoom-in" data-aos-delay="400" className='uppercase bg-themepurple hover:bg-themeyellow text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-8'>View More</button>

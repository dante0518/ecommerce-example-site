...
const Services = () => {
    ...
    return (
        <div className='w-full lg:px-20 px-5 pt-[0px] pb-[80px] grid lg:grid-cols-4 gird-cols-1 justify-center items-center gap-10 '>
            ...
            <div data-aos="zoom-in" data-aos-delay="100" className='flex flex-col justify-center items-center gap-2'>
                ...
                <h1 className='text-xl text-black font-semibold'>Free return in 30 days</h1>
                <p className='text-[17px] text-gray-500  '>Lorem ipsum dolor sit amet.</p>
            </div>
            <div data-aos="zoom-in" data-aos-delay="100" className='flex flex-col justify-center items-center gap-2'>
                <img src={gift} alt="" className='mb-[20px] w-[60px] ' />
                <h1 className='text-xl text-black font-semibold'>Gifting Service </h1>
                <p className='text-[17px] text-gray-500  '>Lorem ipsum dolor sit amet.</p>
            </div>
